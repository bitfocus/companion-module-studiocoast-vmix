...
| SetDynamicValue4 | General - Set Dynamic Inputs and Values |
| Undo | Input - Undo |
...
| Shortcuts | Actions |
| --- | --- |
| Audio | Audio - Input Mute |
| AudioAuto | Audio - Input Audio Auto |
| AudioAutoOff | Audio - Input Audio Auto |
| AudioAutoOn | Audio - Input Audio Auto |
| AudioBus | Audio - Route Input to Bus |
| AudioBusOff | Audio - Route Input to Bus |
| AudioBusOn | Audio - Route Input to Bus |
| AudioChannelMatrixApplyPreset | Audio - Channel Matrix Apply Preset |
| AudioMixerShowHide | Audio - Show / Hide Audio Mixer |
| AudioOff | Audio - Input Mute |
| AudioOn | Audio - Input Mute |
| AudioPluginOff | Audio - Audio Plugin On/Off/Toggle/Show On Input |
...
| SetBusBVolumeFade | Audio - Fade Bus Volume |
| SetBusCVolume | Audio - Set Bus Volume |
| SetBusCVolumeFade | Audio - Fade Bus Volume |
| SetBusDVolume | Audio - Set Bus Volume |
| SetBusDVolumeFade | Audio - Fade Bus Volume |
| SetBusEVolume | Audio - Set Bus Volume |
| SetBusEVolumeFade | Audio - Fade Bus Volume |
| SetBusFVolume | Audio - Set Bus Volume |
...
| SetVolumeChannelMixer1 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer2 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer3 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer4 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer5 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer6 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer7 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer8 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer9 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer10 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer11 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer12 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer13 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer14 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer15 | Audio - Set Input Channel Volume |
| SetVolumeChannelMixer16 | Audio - Set Input Channel Volume |
| SetVolumeFade | Audio - Fade Input Volume |
| Solo | Audio - Input Solo |
...
| Shortcuts | Actions |
| --- | --- |
| Fade | Transition - Transition Mix |
| Zoom | Transition - Transition Mix |
| Wipe | Transition - Transition Mix |
| Slide | Transition - Transition Mix |
| Fly | Transition - Transition Mix |
| CrossZoom | Transition - Transition Mix |
| FlyRotate | Transition - Transition Mix |
| Cube | Transition - Transition Mix |
| CubeZoom | Transition - Transition Mix |
| VerticalWipe | Transition - Transition Mix |
| VerticalSlide | Transition - Transition Mix |
| Merge | Transition - Transition Mix |
| WipeReverse | Transition - Transition Mix |
| SlideReverse | Transition - Transition Mix |
| VerticalWipeReverse | Transition - Transition Mix |
| VerticalSlideReverse | Transition - Transition Mix |
| BarnDoor | Transition - Transition Mix |
| RollerDoor | Transition - Transition Mix |
| AlphaFade | Transition - Transition Mix |
| Cut | Transition - Transition Mix |
| CutDirect | Transition - Send Input to Program |
...
| SetTransitionDuration4 | Transition - Set Auto Transition Duration |
| SetTransitionEffect1 | Transition - Set Auto Transition Effect |
| SetTransitionEffect2 | Transition - Set Auto Transition Effect |
| SetTransitionEffect3 | Transition - Set Auto Transition Effect |
| SetTransitionEffect4 | Transition - Set Auto Transition Effect |
| Stinger1 | Transition - Auto/Stinger Transition |
| Stinger2 | Transition - Auto/Stinger Transition |
| Stinger3 | Transition - Auto/Stinger Transition |
| Stinger4 | Transition - Auto/Stinger Transition |
| Stinger5 | Transition - Auto/Stinger Transition |
| Stinger6 | Transition - Auto/Stinger Transition |
| Stinger7 | Transition - Auto/Stinger Transition |
| Stinger8 | Transition - Auto/Stinger Transition |
| Transition1 | Transition - Auto/Stinger Transition |
| Transition2 | Transition - Auto/Stinger Transition |
| Transition3 | Transition - Auto/Stinger Transition |
| Transition4 | Transition - Auto/Stinger Transition |
...
| FullscreenOff | Output - Fullscreen |
| FullscreenOn | Output - Fullscreen |
| SetOutput2 | Output - Set Output Source |
| SetOutput3 | Output - Set Output Source |
| SetOutput4 | Output - Set Output Source |
...
| Effect2 | Input - Effect Toggle/On/Off |
| Effect2Off | Input - Effect Toggle/On/Off |
| Effect2On | Input - Effect Toggle/On/Off |
| Effect3 | Input - Effect Toggle/On/Off |
| Effect3Off | Input - Effect Toggle/On/Off |
| Effect3On | Input - Effect Toggle/On/Off |
| Effect4 | Input - Effect Toggle/On/Off |
...
| MarkIn | Playback - Mark Functions |
| MarkOut | Playback - Mark Functions |
...
| Play | Playback - Playback Actions |
| PlayPause | Playback - Playback Actions |
| PreviewInput | Input - Send Input to Preview |
| PreviewInputNext | Input - Send Next input to Preview |
...
| SetCropX1 | Input - Position |
| SetCropX2 | Input - Position |
| SetCropY1 | Input - Position |
| SetCropY2 | Input - Position |
| SetDynamicInput1 | General - Set Dynamic Inputs and Values |
| SetDynamicInput2 | General - Set Dynamic Inputs and Values |
| SetDynamicInput3 | General - Set Dynamic Inputs and Values |
| SetDynamicInput4 | General - Set Dynamic Inputs and Values |
| SetEffect1Strength | Input - Effect Strength |
| SetEffect2Strength | Input - Effect Strength |
...
| SetLayer1CropY1 | Layer - Position |
| SetLayer1CropY2 | Layer - Position |
| SetLayer1Height | Layer - Position |
| SetLayer1PanX | Layer - Position |
| SetLayer1PanY | Layer - Position |
| SetLayer1Rectangle | Layer - Position |
| SetLayer1Width | Layer - Position |
| SetLayer1X | Layer - Position |
| SetLayer1Y | Layer - Position |
| SetLayer1Zoom | Layer - Position |
| SetLayer2Crop | Layer - Position |
| SetLayer2CropX1 | Layer - Position |
| SetLayer2CropX2 | Layer - Position |
| SetLayer2CropY1 | Layer - Position |
| SetLayer2CropY2 | Layer - Position |
| SetLayer2Height | Layer - Position |
| SetLayer2PanX | Layer - Position |
| SetLayer2PanY | Layer - Position |
| SetLayer2Rectangle | Layer - Position |
| SetLayer2Width | Layer - Position |
| SetLayer2X | Layer - Position |
| SetLayer2Y | Layer - Position |
| SetLayer2Zoom | Layer - Position |
| SetLayer3Crop | Layer - Position |
| SetLayer3CropX1 | Layer - Position |
| SetLayer3CropX2 | Layer - Position |
| SetLayer3CropY1 | Layer - Position |
| SetLayer3CropY2 | Layer - Position |
| SetLayer3Height | Layer - Position |
| SetLayer3PanX | Layer - Position |
| SetLayer3PanY | Layer - Position |
| SetLayer3Rectangle | Layer - Position |
| SetLayer3Width | Layer - Position |
| SetLayer3X | Layer - Position |
| SetLayer3Y | Layer - Position |
| SetLayer3Zoom | Layer - Position |
| SetLayer4Crop | Layer - Position |
| SetLayer4CropX1 | Layer - Position |
| SetLayer4CropX2 | Layer - Position |
| SetLayer4CropY1 | Layer - Position |
| SetLayer4CropY2 | Layer - Position |
| SetLayer4Height | Layer - Position |
| SetLayer4PanX | Layer - Position |
| SetLayer4PanY | Layer - Position |
| SetLayer4Rectangle | Layer - Position |
| SetLayer4Width | Layer - Position |
| SetLayer4X | Layer - Position |
| SetLayer4Y | Layer - Position |
| SetLayer4Zoom | Layer - Position |
| SetLayer5Crop | Layer - Position |
| SetLayer5CropX1 | Layer - Position |
| SetLayer5CropX2 | Layer - Position |
| SetLayer5CropY1 | Layer - Position |
| SetLayer5CropY2 | Layer - Position |
| SetLayer5Height | Layer - Position |
| SetLayer5PanX | Layer - Position |
| SetLayer5PanY | Layer - Position |
| SetLayer5Rectangle | Layer - Position |
| SetLayer5Width | Layer - Position |
| SetLayer5X | Layer - Position |
| SetLayer5Y | Layer - Position |
| SetLayer5Zoom | Layer - Position |
| SetLayer6Crop | Layer - Position |
| SetLayer6CropX1 | Layer - Position |
| SetLayer6CropX2 | Layer - Position |
| SetLayer6CropY1 | Layer - Position |
| SetLayer6CropY2 | Layer - Position |
| SetLayer6Height | Layer - Position |
| SetLayer6PanX | Layer - Position |
| SetLayer6PanY | Layer - Position |
| SetLayer6Rectangle | Layer - Position |
| SetLayer6Width | Layer - Position |
| SetLayer6X | Layer - Position |
| SetLayer6Y | Layer - Position |
| SetLayer6Zoom | Layer - Position |
| SetLayer7Crop | Layer - Position |
| SetLayer7CropX1 | Layer - Position |
| SetLayer7CropX2 | Layer - Position |
| SetLayer7CropY1 | Layer - Position |
| SetLayer7CropY2 | Layer - Position |
| SetLayer7Height | Layer - Position |
| SetLayer7PanX | Layer - Position |
| SetLayer7PanY | Layer - Position |
| SetLayer7Rectangle | Layer - Position |
| SetLayer7Width | Layer - Position |
| SetLayer7X | Layer - Position |
| SetLayer7Y | Layer - Position |
| SetLayer7Zoom | Layer - Position |
| SetLayer8Crop | Layer - Position |
| SetLayer8CropX1 | Layer - Position |
| SetLayer8CropX2 | Layer - Position |
| SetLayer8CropY1 | Layer - Position |
| SetLayer8CropY2 | Layer - Position |
| SetLayer8Height | Layer - Position |
| SetLayer8PanX | Layer - Position |
| SetLayer8PanY | Layer - Position |
| SetLayer8Rectangle | Layer - Position |
| SetLayer8Width | Layer - Position |
| SetLayer8X | Layer - Position |
| SetLayer8Y | Layer - Position |
| SetLayer8Zoom | Layer - Position |
| SetLayer9Crop | Layer - Position |
| SetLayer9CropX1 | Layer - Position |
| SetLayer9CropX2 | Layer - Position |
| SetLayer9CropY1 | Layer - Position |
| SetLayer9CropY2 | Layer - Position |
| SetLayer9Height | Layer - Position |
| SetLayer9PanX | Layer - Position |
| SetLayer9PanY | Layer - Position |
| SetLayer9Rectangle | Layer - Position |
| SetLayer9Width | Layer - Position |
| SetLayer9X | Layer - Position |
| SetLayer9Y | Layer - Position |
| SetLayer9Zoom | Layer - Position |
| SetLayer10Crop | Layer - Position |
| SetLayer10CropX1 | Layer - Position |
| SetLayer10CropX2 | Layer - Position |
| SetLayer10CropY1 | Layer - Position |
| SetLayer10CropY2 | Layer - Position |
| SetLayer10Height | Layer - Position |
| SetLayer10PanX | Layer - Position |
| SetLayer10PanY | Layer - Position |
| SetLayer10Rectangle | Layer - Position |
| SetLayer10Width | Layer - Position |
...
| OverlayInput1 | Overlay - Functions |
| OverlayInput1In | Overlay - Functions |
| OverlayInput1Last | Overlay - Functions |
| OverlayInput1Off | Overlay - Functions |
| OverlayInput1Out | Overlay - Functions |
| OverlayInput1Zoom | Overlay - Functions |
| OverlayInput2 | Overlay - Functions |
| OverlayInput2In | Overlay - Functions |
| OverlayInput2Last | Overlay - Functions |
| OverlayInput2Off | Overlay - Functions |
| OverlayInput2Out | Overlay - Functions |
| OverlayInput2Zoom | Overlay - Functions |
| OverlayInput3 | Overlay - Functions |
| OverlayInput3In | Overlay - Functions |
| OverlayInput3Last | Overlay - Functions |
| OverlayInput3Off | Overlay - Functions |
| OverlayInput3Out | Overlay - Functions |
| OverlayInput3Zoom | Overlay - Functions |
| OverlayInput4 | Overlay - Functions |
| OverlayInput4In | Overlay - Functions |
| OverlayInput4Last | Overlay - Functions |
| OverlayInput4Off | Overlay - Functions |
| OverlayInput4Out | Overlay - Functions |
| OverlayInput4Zoom | Overlay - Functions |
| OverlayInput5 | Overlay - Functions |
| OverlayInput5In | Overlay - Functions |
| OverlayInput5Last | Overlay - Functions |
| OverlayInput5Off | Overlay - Functions |
| OverlayInput5Out | Overlay - Functions |
| OverlayInput5Zoom | Overlay - Functions |
| OverlayInput6 | Overlay - Functions |
| OverlayInput6In | Overlay - Functions |
| OverlayInput6Last | Overlay - Functions |
| OverlayInput6Off | Overlay - Functions |
| OverlayInput6Out | Overlay - Functions |
| OverlayInput6Zoom | Overlay - Functions |
| OverlayInput7 | Overlay - Functions |
| OverlayInput7In | Overlay - Functions |
| OverlayInput7Last | Overlay - Functions |
| OverlayInput7Off | Overlay - Functions |
| OverlayInput7Out | Overlay - Functions |
| OverlayInput7Zoom | Overlay - Functions |
| OverlayInput8 | Overlay - Functions |
| OverlayInput8In | Overlay - Functions |
| OverlayInput8Last | Overlay - Functions |
| OverlayInput8Off | Overlay - Functions |
| OverlayInput8Out | Overlay - Functions |
| OverlayInput8Zoom | Overlay - Functions |
| OverlayInputAllOff | Overlay - Functions |
| PreviewOverlayInput1 | Overlay - Functions |
| PreviewOverlayInput2 | Overlay - Functions |
| PreviewOverlayInput3 | Overlay - Functions |
| PreviewOverlayInput4 | Overlay - Functions |
| PreviewOverlayInput5 | Overlay - Functions |
| PreviewOverlayInput6 | Overlay - Functions |
| PreviewOverlayInput7 | Overlay - Functions |
| PreviewOverlayInput8 | Overlay - Functions |
| SetMultiViewOverlay | Layer - Set Input as Multiview Layer |


## PlayList
| Shortcuts | Actions |
| --- | --- |
| NextPlayListEntry | Playlist - Functions |
| PreviousPlayListEntry | Playlist - Functions |
| SelectPlayList | Playlist - Open Playlist |
| StartPlayList | Playlist - Functions |
| StopPlayList | Playlist - Functions |
...
| Shortcuts | Actions |
| --- | --- |
| ReplayACamera1 | Replay - A Camera |
| ReplayACamera2 | Replay - A Camera |
| ReplayACamera3 | Replay - A Camera |
| ReplayACamera4 | Replay - A Camera |
...
| ReplayBCamera4 | Replay - B Camera |
| ReplayBCamera5 | Replay - B Camera |
| ReplayBCamera6 | Replay - B Camera |
| ReplayBCamera7 | Replay - B Camera |
| ReplayBCamera8 | Replay - B Camera |
| ReplayCamera1 | Replay - Selected Channel Camera |
| ReplayCamera2 | Replay - Selected Channel Camera |
| ReplayCamera3 | Replay - Selected Channel Camera |
| ReplayCamera4 | Replay - Selected Channel Camera |
| ReplayCamera5 | Replay - Selected Channel Camera |
...
| ReplayMarkInLive | Replay - Mark Functions |
| ReplayMarkInOut | Replay - Mark Functions |
| ReplayMarkInOutLive | Replay - Mark Functions |
| ReplayMarkInOutLiveFuture | Replay - Mark Functions |
| ReplayMarkInOutRecorded | Replay - Mark Functions |
| ReplayMarkInRecorded | Replay - Mark Functions |
| ReplayMarkInRecordedNow | Replay - Mark Functions |
| ReplayMarkOut | Replay - Mark Functions |
| ReplayMoveLastEvent | Replay - Move event |
| ReplayMoveSelectedEvent | Replay - Move event |
| ReplayMoveSelectedEventDown | Replay - Move Selected Event Up/Down |
| ReplayMoveSelectedEventUp | Replay - Move Selected Event Up/Down |
| ReplayMoveSelectedInPoint | Replay - Move Selected Event In/Out |
...
| ReplaySelectEvents4 | Replay - Replay Select Events |
| ReplaySelectEvents5 | Replay - Replay Select Events |
| ReplaySelectEvents6 | Replay - Replay Select Events |
| ReplaySelectEvents7 | Replay - Replay Select Events |
| ReplaySelectEvents8 | Replay - Replay Select Events |
| ReplaySelectEvents9 | Replay - Replay Select Events |
| ReplaySelectEvents10 | Replay - Replay Select Events |
| ReplaySelectEvents11 | Replay - Replay Select Events |
| ReplaySelectEvents12 | Replay - Replay Select Events |
| ReplaySelectEvents13 | Replay - Replay Select Events |
| ReplaySelectEvents14 | Replay - Replay Select Events |
| ReplaySelectEvents15 | Replay - Replay Select Events |
| ReplaySelectEvents16 | Replay - Replay Select Events |
| ReplaySelectEvents17 | Replay - Replay Select Events |
...
| ReplayToggleSelectedEventCamera3 | Replay - Toggle Selected Event Camera |
| ReplayToggleSelectedEventCamera4 | Replay - Toggle Selected Event Camera |
| ReplayToggleSelectedEventCamera5 | Replay - Toggle Selected Event Camera |
| ReplayToggleSelectedEventCamera6 | Replay - Toggle Selected Event Camera |
| ReplayToggleSelectedEventCamera7 | Replay - Toggle Selected Event Camera |
...
| Shortcuts | Actions |
| --- | --- |
| PTZCreateVirtualInput | PTZ - Virtual Input Create/Update |
| PTZFocusAuto | PTZ - Focus & Zoom |
| PTZFocusFar | PTZ - Focus & Zoom |
| PTZFocusManual | PTZ - Focus & Zoom |
| PTZFocusNear | PTZ - Focus & Zoom |
| PTZFocusStop | PTZ - Focus & Zoom |
| PTZHome | PTZ - Move |
| PTZMoveDown | PTZ - Move |
| PTZMoveDownLeft | PTZ - Move |
| PTZMoveDownRight | PTZ - Move |
| PTZMoveLeft | PTZ - Move |
| PTZMoveRight | PTZ - Move |
| PTZMoveStop | PTZ - Move |
| PTZMoveToVirtualInputPosition | PTZ - Move |
| PTZMoveToVirtualInputPositionByIndex | PTZ - Move |
| PTZMoveUp | PTZ - Move |
| PTZMoveUpLeft | PTZ - Move |
| PTZMoveUpRight | PTZ - Move |
| PTZUpdateVirtualInput | PTZ - Virtual Input Create/Update |
| PTZZoomIn | PTZ - Focus & Zoom |
| PTZZoomOut | PTZ - Focus & Zoom |
| PTZZoomStop | PTZ - Focus & Zoom |
...
| Shortcuts | Actions |
| --- | --- |
| DataSourceAutoNextOff | DataSource - AutoNext |
...
| Shortcuts | Actions |
| --- | --- |
| BrowserBack | Browser - Functions |
| BrowserForward | Browser - Functions |
| BrowserKeyboardDisabled | Browser - Functions |
| BrowserKeyboardEnabled | Browser - Functions |
| BrowserMouseDisabled | Browser - Functions |
| BrowserMouseEnabled | Browser - Functions |
| BrowserNavigate | Browser - Navigate |
| BrowserReload | Browser - Functions |
