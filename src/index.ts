...
export default class VMixInstance extends InstanceBase<VMixInstanceTypes> {
  ...
  public async init(config: Config): Promise<void> {
    if (config.debugVersionUpdateNotifications) {
      log.info('v5.0.0 of this module has now been released! Patch notes can be found at https://github.com/bitfocus/companion-module-studiocoast-vmix/blob/main/docs/patch_notes.md')
    }
